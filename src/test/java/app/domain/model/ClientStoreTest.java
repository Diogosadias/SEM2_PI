...
public class ClientStoreTest {
    ...
    public void testValidateClient() {
        ...
        Client c3 = new Client(new Email("usrda31@gmail.com"), "John", 1111511111L, 1111111111111111L, 111111111111L, new Date("2001/12/22"), "M", 11111111111L);
        Client c4 = new Client(new Email("usrd3fr1@gmail.com"), "John", 1111111151L, 1111116111111111L, 111111111111L, new Date("2001/12/22"), "M", 11111111111L);
        Client c5 = new Client(new Email("us5fr1@gmail.com"), "John", 1111111171L, 1111111111171111L, 111111711111L, new Date("2001/12/22"), "M", 11111111111L);
