...
| Step 4: shows the data and requests a confirmation  |	...validating the data globally(eg.: duplicated)? |ParameterCategoryStore          |IE: knows all the ParameterCategory objects.  |
...
**Company Class**
    ...
    public ParameterCategoryStore getParameterCategoryStore(ParameterCategoryStore a){
        return a;
        }
