...
| | ...evaluating the performance | CreateGraph| IE: knows it's own data |
...
| Step 6: informs operation success  		 |	...converting the converted data into a file?						 |  Controller         |      IE: Has it's own data                        |              
